...
# Когато терминалът е отворен от плочката „Ask me", ttyd подава ODOO_FOCUS=ask
# + ODOO_MODEL/ODOO_RES_ID. CLAUDE.md е току-що пресвежен (горе), затова просто
# дописваме — насочваме асистента да зареди knowledge skill-а „ask-about-record"
# (живее в l10n_bg_ai_pipeline, не дублираме тук) и да отговаря за този запис.
